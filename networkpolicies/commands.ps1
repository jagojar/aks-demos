...
# https://docs.microsoft.com/en-us/azure/aks/use-network-policies#code-try-0


RESOURCE_GROUP_NAME="aks-np-rg"
CLUSTER_NAME=myAKSCluster="aks-np"
LOCATION="eastus2"
